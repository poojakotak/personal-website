...
function About() {
    return (
      <section id="about" className="md:pl-[25%] w-full h-screen flex items-center justify-center bg-stone-100">
        <div className="max-w-2xl mx-auto p-4 text-center">
          <img src={placeholderImage} alt="Pooja Kotak" className="rounded-full mx-auto mb-4 w-40 h-40 object-cover" />
          <h2 className="text-5xl font-bold mb-3 text-stone-600">Hi, I'm Pooja!</h2>
          <p className="mb-2 text-l font-bold text-stone-500">I love to learn about tech and build 0 to 1.</p>
